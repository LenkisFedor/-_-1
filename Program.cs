        ...
        static void Main(string[] args)
        {
            ...
            for (int i = 0; i < nrow; i++)
            {
                for (int k = 0; k < ncolumn; k++)
                {
                    ...
                    Console.WriteLine(second[i,k].ToString());
                }
            ...
            for (int i = 0; i < nrow; i++)
            {
                ...
                for (int k = 0; k < ncolumn; k++)
                {
                    ...
                    Console.WriteLine(third[i][k].ToString());
                }
            ...
            Console.WriteLine($"С массивом массивов программа работала {result3} милисекунд или {result3 / 1000} секунд");
            #endregion
        }
